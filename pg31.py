...
botao_classexecutiva = tk.Radiobutton(text="Classe Execuitivo", variable=var_aviao, value = "Classe Executiva")
botao_primeiraclasse = tk.Radiobutton(text="Primeira classe", variable=var_aviao, value = "Primeira Classe")
botao_classeeconomica.grid(row = 0, column = 1) 
botao_classexecutiva.grid(row = 0, column = 2) 
botao_primeiraclasse.grid(row = 0, column = 3)
